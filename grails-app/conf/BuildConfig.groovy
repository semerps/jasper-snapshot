...
grails.project.dependency.resolution = {
    ...
    dependencies {
        ...
        compile('net.sf.jasperreports:jasperreports:6.15.0') {
            excludes 'antlr', 'commons-logging',
                     ...
                     'xercesImpl','xmlParserAPIs','spring-core','bsh', 'spring-beans', 'jaxen', 'barcode4j','persistence-api','jdtcore','bcmail-jdk16','bcprov-jdk16','bctsp-jdk16',
